...
<head>
    ...
    <style>
        ...
        .note { background: rgba(214, 231, 255, 0.08); border: 1px solid rgba(214, 231, 255, 0.25); border-radius: 8px; padding: 12px 16px; color: #cbd5e1; font-size: 0.85rem; }
    </style>
</head>
<body>
    <div class="container">
        <div class="card">
            <h1>Download LuckyBlox</h1>
            <p style="color: #94a3b8; margin-top: -6px;">Get the official LuckyBlox Player and Studio to experience local games.</p>
        </div>

        <div class="download-grid">
            <div class="dl-card">
                <div class="dl-icon">&#128193;</div>
                <div class="dl-title">LuckyBlox Player</div>
                <div class="dl-desc">Launch and play games hosted on the LuckyBlox server.<br />For <strong>2021M</strong> releases and compatible places.</div>
                <div class="dl-meta">Version: <span class="version">2021.5</span></div>
                <a class="dl-btn" href="/downloads/LuckyBlox.exe">Download Player</a>
            </div>

            <div class="dl-card">
                <div class="dl-icon">&#127796;</div>
                <div class="dl-title">LuckyBlox Studio</div>
                <div class="dl-desc">Build, script, and publish your own games for LuckyBlox.<br />Compatible with the local server and Roblox-style APIs.</div>
                <div class="dl-meta">Version: <span class="version">2022M</span></div>
                <a class="dl-btn" href="/downloads/LuckyBloxStudio.exe">Download Studio</a>
            </div>
        </div>
