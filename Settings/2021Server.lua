...
local modulelol9 = game:GetObjects("rbxasset://LoadLibrary.rbxmx")[1]
modulelol9.Parent=game:GetService("ReplicatedStorage")
...
xd = string.gsub(xd,"game:GetService%('MessagingService'%)","require(game:GetService('ReplicatedStorage'):WaitForChild('MessagingService'))")
		...
		xd = string.gsub(xd,'game:GetService%("DataStoreService"%)','require(game:GetService("ReplicatedStorage"):WaitForChild("DataStoreService"))')
		xd = string.gsub(xd,"game:GetService%('MarketplaceService'%)","require(game:GetService('ReplicatedStorage'):WaitForChild('MarketPlaceService'))")
		xd = string.gsub(xd,'game:GetService%("MarketplaceService"%)','require(game:GetService("ReplicatedStorage"):WaitForChild("MarketPlaceService"))')
                xd = string.gsub(xd,'game.MarketplaceService','require(game.ReplicatedStorage:WaitForChild("MarketPlaceService"))')
                xd = string.gsub(xd,'game.GamePassService','require(game.ReplicatedStorage:WaitForChild("LuawebService"))')
               xd = string.gsub(xd,'game:GetService%("GamePassService"%)','require(game:GetService("ReplicatedStorage"):WaitForChild("LuawebService"))')
               xd = string.gsub(xd,"game:GetService%('GamePassService'%)","require(game:GetService('ReplicatedStorage'):WaitForChild('LuawebService'))")

                              xd = string.gsub(xd,'game.BadgeService','require(game.ReplicatedStorage:WaitForChild("LuawebService"))')
               xd = string.gsub(xd,'game:GetService%("BadgeService"%)','require(game:GetService("ReplicatedStorage"):WaitForChild("LuawebService"))')
               xd = string.gsub(xd,"game:GetService%('BadgeService'%)","require(game:GetService('ReplicatedStorage'):WaitForChild('LuawebService'))")
               xd = string.gsub(xd,':IsInGroup','.userId-')
               xd = string.gsub(xd,':GetRankInGroup','.userId-')
               xd = string.gsub(xd,':IsFriendsWith','.userId==')
               	xd = string.gsub(xd,"game:GetService%('PointsService'%)","require(game:GetService('ReplicatedStorage'):WaitForChild('PointsService'))")
		xd = string.gsub(xd,'game:GetService%("PointsService"%)','require(game:GetService("ReplicatedStorage"):WaitForChild("PointsService"))')
                xd = string.gsub(xd,'game.PointsService','require(game.ReplicatedStorage:WaitForChild("PointsService"))')

               	xd = string.gsub(xd,"game:GetService%('GroupService'%)","require(game:GetService('ReplicatedStorage'):WaitForChild('GroupService'))")
		xd = string.gsub(xd,'game:GetService%("GroupService"%)','require(game:GetService("ReplicatedStorage"):WaitForChild("GroupService"))')
                xd = string.gsub(xd,'game.GroupService','require(game.ReplicatedStorage:WaitForChild("GroupService"))')

	xd = string.gsub(xd,"game:GetService%('InsertService'%)","require(game:GetService('ReplicatedStorage'):WaitForChild('InsertService'))")
		xd = string.gsub(xd,'game:GetService%("InsertService"%)','require(game:GetService("ReplicatedStorage"):WaitForChild("InsertService"))')
                xd = string.gsub(xd,'game.InsertService','require(game.ReplicatedStorage:WaitForChild("InsertService"))')


		xd = string.gsub(xd,'game.Chat','require(game:GetService("ReplicatedStorage"):WaitForChild("Chat"))')
               xd = string.gsub(xd,'game:GetService%("Chat"%)','require(game:GetService("ReplicatedStorage"):WaitForChild("Chat"))')
xd = string.gsub(xd,"game:GetService%('Chat'%)","require(game:GetService('ReplicatedStorage'):WaitForChild('Chat'))")
a.Source=xd
end
